...
void main() {
    ...
    m_params.Roughness = texture(u_material.MetallicRoughnessTexture, v_texCoord).g * u_material.Roughness;
    m_params.Metalness = texture(u_material.MetallicRoughnessTexture, v_texCoord).r * u_material.Metalness;
