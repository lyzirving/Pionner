...
namespace pio
{
	...
	Ref<Shader> GLShaderCompiler::doCompile(Ref<RenderContext>& context)
	{
	...
	Ref<Shader> GLShaderCompiler::DoExecute(Ref<RenderContext>& context, const std::string& path)
	{
		...
		return compiler.doCompile(context);
	}
